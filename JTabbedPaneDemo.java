...
public class JTabbedPaneDemo extends JPanel {
    public JTabbedPaneDemo() {
        ...
        JPanel jplInnerPanel1 = createInnerPanel("Options related to questions");
        jtbExample.addTab("One", icon, jplInnerPanel1, "Quiz");
        jtbExample.setSelectedIndex(0);

        JPanel jplInnerPanel2 = createInnerPanel("Contestants");
